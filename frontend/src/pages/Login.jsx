    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-amber-50 via-amber-100 to-orange-50 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-20 left-10 w-20 h-20 bg-amber-200/30 rounded-full blur-xl animate-float-slow"></div>
                <div className="absolute top-1/2 right-20 w-32 h-32 bg-orange-200/40 rounded-full blur-2xl animate-float-medium delay-1000"></div>
                <div className="absolute bottom-32 left-1/4 w-24 h-24 bg-amber-300/50 rounded-full blur-xl animate-float-fast delay-2000"></div>
            </div>
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-12 group">
                    <div className="inline-block p-6 bg-linear-to-br from-amber-100 via-amber-200 to-orange-100 rounded-3xl shadow-2xl group-hover:scale-105 transition-all duration-700 hover:shadow-3xl mb-6 border border-amber-200/50 backdrop-blur-sm">
                        <div className="relative">
                            ...
                            <div className="absolute -inset-2 bg-linear-to-r from-amber-400/20 to-orange-400/20 rounded-3xl blur animate-pulse"></div>
                        </div>
                    </div>
                    ...
                    <p className="text-xl text-amber-700 font-light tracking-wide">Your digital time capsule ✨</p>
                </div>
                        ...
                        >
                            ...
                            {loading ? (
                                <span className="flex items-center justify-center gap-3 relative z-10">
                                    ...
                                    <span className="tracking-wide">Opening Memories...</span>
                                </span>
                            ) : (
                                <span className="relative z-10 tracking-wide">Enter Time Capsule</span>
                            )}
                        </button>
                    </form>
                ...
                <div className="text-center mt-12 relative z-10">
                    <p className="text-amber-700 font-light text-lg tracking-wide drop-shadow-sm">
                        Preserve your precious memories for tomorrow <span className="text-2xl">🕰️✨</span>
                    </p>
                </div>
            </div>
        </div>
